  ...
  <div class="submission-detail">
    ...
    <div class="resource-content" v-if="!loading">
      ...
      <div class="section" v-if="resource.usage_declaration">
        <h3>Usage Declaration</h3>
        <p class="text">{{ resource.usage_declaration }}</p>
      </div>

      <div class="timestamps">
        <p><strong>Created:</strong> {{ formatDateTime(resource.created_time) }}</p>
        <p><strong>Last Submitted:</strong> {{ formatDateTime(resource.last_submitted_time) }}</p>
        <p><strong>Last Updated:</strong> {{ formatDateTime(resource.last_updated_time) }}</p>
        <p v-if="resource.last_published_time"><strong>Published:</strong> {{ formatDateTime(resource.last_published_time) }}</p>
      </div>
    </div>
